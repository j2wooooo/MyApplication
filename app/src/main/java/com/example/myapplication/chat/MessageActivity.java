...
//                    } else
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            ...
            if(comments.get(position).uid.equals(uid)){
                ...
                messageViewHolder.textView_message.setBackgroundResource(R.drawable.leftbubble); // 내 메세지의 버블이미지 <- 이름 잘못지정해준듯 ㅠ
                // 상대방 메시지 레이아웃을 감춘다.
                messageViewHolder.linearLayout_destination.setVisibility(View.INVISIBLE);
                messageViewHolder.textView_message.setTextSize(25); // 메세지 글자크기
